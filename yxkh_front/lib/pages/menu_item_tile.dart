      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Icon(
              widget.icon,
              color: widget.isSelected ? DashboardTheme.selectedColor : Colors.white30,
              size: 38,
            ),
            SizedBox(
            ...
            ? Text(widget.title,style: widget.isSelected? DashboardTheme.menuListTileSelectedText: DashboardTheme.menuListTileDefaultText)
            : Container()
          ],
        ),
      ),
